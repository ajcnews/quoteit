...
$("#paintItBlack").click(function() {
	$("#poster").css({"background-color": "#000000"});
	$("#quote-p").css({"color": "#ffffff"});
	$("#attr-p").css({"color": "#ffffff"});
});

$("#paintItWhite").click(function() {
	$("#poster").css({"background-color": "#ffffff"}); 
	$("#quote-p").css({"color": "#000000"});
	$("#attr-p").css({"color": "#000000"});
});
